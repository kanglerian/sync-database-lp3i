...
API Gateway LP3I adalah server backend yang dirancang untuk mendukung aplikasi di LP3I. Dibangun dengan menggunakan framework Express.js, server ini menyediakan layanan backend yang kuat untuk mengelola data dan fungsi-fungsi aplikasi LP3I.
